...
//        Cart cart = new Cart(shop);
    ...
    void quantityProductsStoreChanging() {
        cart.addProductToCartByID(1);
        cart.addProductToCartByID(1);
        int afterValue= shop.getProductsShop().get(0).getQuantity();
        assertThat(afterValue).isEqualTo(8);
    ...
    void deletedProductIsReturnedToShop() {
        ...
        int baconInCart= cart.cartItems.get(0).getQuantity();

        assertThat(baconInCart).isEqualTo(3);
        ...
        int baconInShop= shop.getProductsShop().get(0).getQuantity();
        assertThat(baconInShop).isEqualTo(9);
